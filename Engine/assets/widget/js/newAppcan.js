/*! appcan v0.1.14 |  from 3g2win.com *//* Zepto v1.1.4 - zepto event ajax form ie - zeptojs.com/license */
var Zepto = (function() {
...
appcan && appcan.define('request',function($,exports,module){
  ...
  function processCompleteResult(xhr,opcode,status,result,requestCode,response,deferred){
      ...
      if (status == 1) {
          if(requestCode == 200 || requestCode == undefined){
            //todo release 
  ...
  function serialize(params, obj, traditional, scope){
    ...
    */
    ...
    function clearOffline(url,callback){
        var argObj = null;
        ...
        var offlineUrl = encodeURIComponent(url);
        if(offlinedata != null){
...
window.appcan && appcan.define('frame',function($,exports,module){
    ...
    function ajax(opts) {
        if (arguments.length === 1 && appcan.isPlainObject(opts)) {
            ...
            if(opts.expires && typeof(opts.expires) == 'string'){
                                        ...
                                        callback:function(err,data,dataType,optId){
                                            if(err == null){
                                                ...
                                                if (typeof(tempSucc) == 'function') {
                                                    ...
                                                    setLocalStorage(url, data, expires);
                                                }
                                            }else{
                                                var tempSucc = opts.success;
                                                ...
                                                opts.success = function(res) {
                                                    ...
                                                    setLocalStorage(url, res, expires);
                                                };
    ...
    function setLocalStorage(fileUrl, fileData, exp) {
        try {
            ...
            appcan.file.write({
                ...
                callback:function(err){
                    if(err == null){
                        ...
                        if (fileData.timeout) {
                            saveData['timeout'] = fileData.timeout;
                        }
...
appcan.define("icache", function($, exports, module) {
    ...
    iCache.prototype = {
        ...
        _download : function(session) {
            ...
            var fpath = self.realpath + "/icache/" + fid + ".jpg";
            //uexLog.sendLog("fpath=="+fpath)
            ...
            self.once("CDL" + session.id, function(data) {
                if (!data) {
                    ...
                    //uexLog.sendLog(session.url+"<========>"+fpath)

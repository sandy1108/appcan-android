...
public abstract class EUExBase {
    ...
    public final void addViewToWebView(View child,
        ...
        mBrwView.addCustomView(child, params);
    }
    ...
    public final void removeViewFromWebView(String id) {
        if (!TextUtils.isEmpty(id)) {
            int viewCount = mBrwView.getCustomChildCount();
            for (int i = viewCount - 1; i >= 0; i--) {
                if (id.equals(mBrwView.getCustomChildAt(i).getTag())) {
                    mBrwView.removeCustomView(mBrwView.getCustomChildAt(i));
                    break;
                }
            }
        }

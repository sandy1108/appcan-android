...
public class DLPluginManager {
    ...
    public DLPluginPackage loadApk(String dexPath) {
        ...
        // by host.
		return loadApk(dexPath, true, null, null);
    }
	...
	public DLPluginPackage loadApk(final String dexPath, boolean hasSoLib,
			ClassLoader parentClassLoader, AssetManager assetManager) {
		...
		DLPluginPackage pluginPackage = preparePluginEnv(packageInfo, dexPath,
				parentClassLoader, assetManager);
        if (hasSoLib) {
            copySoLib(dexPath);
        }
	...
	private DLPluginPackage preparePluginEnv(PackageInfo packageInfo,
		...
		DexClassLoader dexClassLoader = createDexClassLoader(dexPath,
				parentClassLoader);
		assetManager = createAssetManager(dexPath, assetManager);
